...
\usepackage{ifthen} % Para realizar operaciones lógicas - usado en la nomenclatura
...
\renewcommand{\nomgroup}[1]{%
  \item[\bfseries
  \ifthenelse{\equal{#1}{N}}{Nomenclatura}{%
  \ifthenelse{\equal{#1}{S}}{Simbología}{}}%
]}
...
\include{apendices/apendice6-DiagramasFlujo}
\part{Anexos}
\anexo
\renewcommand{\thesection}{A.~\arabic{section}}
