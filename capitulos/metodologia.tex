...
Medir dimensiones y características de partículas individuales es un proceso tardado y costoso, por ello existen escalas cualitativas que permiten una rápida evaluación visual de la misma. Dichas escalas evalúan parámetros como la angularidad y esfericidad,como la usada en la norma ASTM F1632 2003, que se muestra en la Figura \ref{fig:Esfericidaddd}.
...
Posteriormente, se calcula la potencia de diseño con la ecuación (\ref{eq:PotDis}), para lo cual es necesario conocer la potencia que la banda debe transmitir (ecuación (\ref{eq:PotBanda})), así como el factor de servicio que se obtiene de tablas\cite{Mott}, con base en la aplicación, el tipo de motor y el tiempo de operación.
...
En donde $F_{n}$ es la fuerza neta asociada al par transmitido, $F_{s}$ es la fuerza flexionante, $T_{banda}$ es el torque transmitido por la banda y $r$ es el radio de la polea.
...
En donde $S_n$ es el límite de fatiga, $S_u$ es el esfuerzo último a la tensión, $S'_n$ es el límite de fatiga modificado, $C_m$ es el factor del material, $C_{st}$ es el factor del tipo de esfuerzo, $C_R$ es el factor de confiabilidad y $C_s$ es el factor de tamaño.
