...
Las piezas correspondientes a la base fija que se une a la estructura junto con el cilindro sobre el que se colocan los rodamientos se muestran en la Figura \ref{fig:PiezasBaseManipulador}a, mientras que la base giratoria sobre la que se colocan los motores del segundo y tercer GDL se observa en la Figura \ref{fig:PiezasBaseManipulador}b.
...
\begin{figure}
	...
	\label{fig:PiezasBaseManipulador}
\end{figure}
